            ...
            db.ref('/').once('value', function(snapshot) {
                ...
                for (i=id-1; i >= 0; i--) {
                    db.ref('/jokes/joke'+i).once('value', function(snapshot) {
                        ...
                        jokesdiv.innerHTML += '<div style="padding-left:15rem; padding-right:15rem"><div class="card"><div class="card-header">#'+snapshot.val()[lastindex].category+'</div><div class="card-body"><blockquote class="blockquote mb-0"><p>'+ snapshot.val()[lastindex].setup +'</p><p>'+ snapshot.val()[lastindex].joke +'</p><footer class="blockquote-footer">Created By: <cite title="Source Title">'+ snapshot.val()[lastindex].author +'</cite></footer></blockquote></div><div class="card-footer text-muted">'+ snapshot.val()[lastindex].date_posted +'</div></div></div><br>'
                        }
                        else if (snapshot.val()[lastindex].category == "Knock Knock") {
                        jokesdiv.innerHTML += '<div style="padding-left:15rem; padding-right:15rem"><div class="card"><div class="card-header">#'+snapshot.val()[lastindex].category+'</div><div class="card-body"><blockquote class="blockquote mb-0"><p>Knock Knock!</p><p>Who\'s there?<p>'+ snapshot.val()[lastindex].setup +'</p><p>'+ snapshot.val()[lastindex].setup +' who?</p><p>'+ snapshot.val()[lastindex].joke +'</p><footer class="blockquote-footer">Created By: <cite title="Source Title">'+ snapshot.val()[lastindex].author +'</cite></footer></blockquote></div><div class="card-footer text-muted">'+ snapshot.val()[lastindex].date_posted +'</div></div></div><br>'
                        }
                    });
                }
            });
                ...
                for (i=id-1; i >= 0; i--) {
                    db.ref('/jokes/joke'+i).once('value', function(snapshot) {   
                        ...
                        if (snapshot.val()[lastindex].authorid == authorid){
                            ...
                            mydiv.innerHTML += '<div style="padding-left:15rem; padding-right:15rem"><div class="card"><div class="card-header">#'+snapshot.val()[lastindex].category+'</div><div class="card-body"><blockquote class="blockquote mb-0"><p>'+ snapshot.val()[lastindex].setup +'</p><p>'+ snapshot.val()[lastindex].joke +'</p><footer class="blockquote-footer"><cite title="Source Title">id: <div style="margin-left: 40px; margin-top: -24px;">'+ snapshot.val()[lastindex].id +'</div></cite></footer></blockquote></div><div class="card-footer text-muted">'+ snapshot.val()[lastindex].date_posted +'<button type="button" style="float:right;" class="btn btn-danger" onclick="deletejoke('+snapshot.val()[lastindex].id+')">Delete</button></div></div></div><br>'
                            }
                            else if (snapshot.val()[lastindex].category == "Knock Knock") {
                            mydiv.innerHTML += '<div style="padding-left:15rem; padding-right:15rem"><div class="card"><div class="card-header">#'+snapshot.val()[lastindex].category+'</div><div class="card-body"><blockquote class="blockquote mb-0"><p>Knock Knock!</p><p>Who\'s there?<p>'+ snapshot.val()[lastindex].setup +'</p><p>'+ snapshot.val()[lastindex].setup +' who?</p><p>'+ snapshot.val()[lastindex].joke +'</p><footer class="blockquote-footer"><cite title="Source Title">id: <div style="margin-left: 40px; margin-top: -24px;">'+ snapshot.val()[lastindex].id +'</div></cite></footer></blockquote></div><div class="card-footer text-muted">'+ snapshot.val()[lastindex].date_posted +'<button type="button" style="float:right;" class="btn btn-danger" onclick="deletejoke('+snapshot.val()[lastindex].id+')">Delete</button></div></div></div><br>'
                            }
                        }
                    });
                }
